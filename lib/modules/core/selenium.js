...
module.exports = function (grunt, config) {
    ...
    config.exec.selenium_test = {
        ...
        + 'TEST=uat <%= utils.php %>/vendor/bin/phpunit -c tests/selenium '
    ...
    config.exec.selenium_notify_success = {
        cmd: 'notify-send "<%= pkg.camelCase %>" "Selenium tests success!"'
    };

    config.exec.selenium_notify_fail = {
        cmd: 'notify-send "<%= pkg.camelCase %>" "Selenium tests failed!"'
    };
