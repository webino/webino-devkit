...
module.exports = function (grunt, config) {
    ...
    config.exec.composer_update      = {cmd: 'COMPOSER_DISCARD_CHANGES=true php <%= utils.php %>/composer.phar update -n --prefer-dist --no-dev'};
    config.exec.composer_update_dev  = {cmd: 'COMPOSER_DISCARD_CHANGES=true php <%= utils.php %>/composer.phar update -n --prefer-dist'};
