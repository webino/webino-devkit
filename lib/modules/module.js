...
exports.config = (function () {
    function config(grunt, config) {
        ...
        config.exec.tester = {cmd: '<%= utils.php %>/vendor/bin/tester -p php-cgi -c tests/tester/php.ini --coverage ._log/clover.xml --coverage-src src/ tests/tester/'};
        ...
        config.tasks.test = {
            ...
            function: [
                ...
                'mkdir:log',
                'phplint',
                grunt.file.exists('<%= basedir %>/tests/phpunit.xml') && 'phpunit' || 'exec:tester',
                'phpcs'
            ]
        };
