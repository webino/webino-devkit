...
exports.config = (function () {
    function config(grunt, config) {
        ...
        config.exec.tester    = {cmd: 'TEST=unit <%= utils.php %>/vendor/bin/tester -p php-cgi -d zend_extension=xdebug.so -d max_execution_time=1200 --coverage ._log/clover.xml --coverage-src src/ tests/tester/<%= grunt.template.tester() %>'};
